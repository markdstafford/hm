  ...
  return (
    <section aria-labelledby="add-source-heading" className="space-y-4">
      ...
      <div className="space-y-2">
        <button
          type="button"
          onClick={onSelectJira}
          className="w-full text-left rounded border border-border p-3 hover:bg-surface transition-colors"
          aria-label="Jira Data Center"
        >
        ...
        <div className="rounded border border-border p-3 opacity-50 cursor-not-allowed">
